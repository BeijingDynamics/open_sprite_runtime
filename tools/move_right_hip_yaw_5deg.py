...
from open_sprite_runtime.single_joint_hold import run_right_hip_yaw_low_gain_motion
...
def main() -> None:
    ...
    with SocketCanSingleMotorMitWriter.open(
        ...
        motion = run_right_hip_yaw_low_gain_motion(
            writer, endpoint, soft_position_rad=tuple(record["soft_limit_rad"])
        )
    report = {
        "mode": "suspended_right_hip_yaw_direction_audit",
        ...
        "fixed_trajectory": {
            ...
            "maximum_estimated_torque_nm": 1.0,
        },
