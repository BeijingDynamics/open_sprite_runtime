#!/usr/bin/env python3
"""Run the frozen second powered test on Sprite0825 head yaw only."""
...
ACKNOWLEDGEMENT = "ENABLE_HEAD_YAW_LOW_GAIN_MOTION"
...
def main() -> None:
    ...
    report = {
        "mode": "second_powered_single_joint_smooth_excursion",
        "manufacturer_manual": "DM-J3507-2EC Gear Motor User Manual V1.1 2026-04-16",
        "preflight": preflight.to_dict(),
        "fixed_trajectory": {
            "sequence": "current -> current+0.02 -> current-0.02 -> current",
    ...
    if not report["passed"]:
        raise SystemExit("head-yaw low-gain motion failed safety qualification")
